...
import { AppointmentsComponent } from './pages/private/appoiments/appoiments';
...
export const routes: Routes = [
    ...
    children: [
        ...
        { path: "admin/appoiments", component: AppointmentsComponent, canActivate: [authGuard] },
        ...
        { path: "appoiments", component: AppointmentsComponent, canActivate: [authGuard] },
